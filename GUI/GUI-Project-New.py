...
class Login:
    ...
    def __init__(self,root):
        ...
        self.l2 = Label(self.f1, text="Username", font=("Times New Roman",12, "italic"),bg="Skyblue")
        self.l2.pack()
        self.e1 = Entry(self.f1, width=20)
        self.e1.pack()
        self.l3 = Label(self.f1, text="Password", font=("Times New Roman",12, "italic"),bg="Skyblue")
        self.l3.pack()
